###
# port 8201 testing
# module "vault_hvd_private_lb_test_primary" {
...
#   # Common
#   #------------------------------------------------------------------------------
#   friendly_name_prefix = "vault-priv"
...
#   net_ingress_lb_cluster_cidr_blocks = [data.aws_vpc.secondary.cidr_block, data.aws_vpc.primary.cidr_block]
...
# module "vault_private_test_lb_hvd_dr" {
#   source = "git@github.com:hashicorp/terraform-aws-vault-enterprise-hvd?ref=feat/add-8201-listener"
#   # source = "git@github.com:nphilbrook/terraform-aws-vault-enterprise-hvd?ref=nphilbrook_custom_target_groups"
...
#   # Common
#   #------------------------------------------------------------------------------
#   friendly_name_prefix = "e2drvault-priv"
#   vault_fqdn           = local.vault_dr
#   # later
#   vault_version = "1.21.3+ent"
...
#   # Testing cluster API LB
#   enable_vault_cluster_port_listener = true
#   net_ingress_lb_cluster_cidr_blocks = [data.aws_vpc.primary.cidr_block, data.aws_vpc.secondary.cidr_block]
